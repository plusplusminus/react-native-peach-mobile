...
#ifndef OPPWAMOBILE_THREEDS_SWIFT_H
#define OPPWAMOBILE_THREEDS_SWIFT_H
...
#import <OPPWAMobile_ThreeDS/OPPWAMobile_ThreeDS.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OPPWAMobile_ThreeDS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP19OPPWAMobile_ThreeDS27OPPThreeDSChallengeCallback_")
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS25OPPThreeDSCompletionEvent")
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS16OPPThreeDSConfig")
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS20OPPThreeDSErrorEvent")
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS22OPPThreeDSSchemeConfig")
...
/// warning:
/// Deprecated. Set protocol version during creation of the transaction <code>OPPThreeDSService.createTransaction(paymentBrand:protocolVersion:)</code>
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS17OPPThreeDSService")
...
/// Creates transaction object for the specific payment brand.
/// warning:
/// Deprecated. Use: <code>createTransaction(paymentBrand:protocolVersion:)</code>
/// note:
/// A reference should be kept for this transaction through the entire 3-D Secure process. When the transaction is complete, it should be closed via the <code>OPPThreeDSTransaction.close()</code>
/// \param paymentBrand brand of the shopper’s card.
///
///
/// throws:
///
...
/// returns:
/// Initialized <code>OPPThreeDSTransaction</code> object.
- (OPPThreeDSTransaction * _Nullable)createTransactionWithPaymentBrand:(NSString * _Nonnull)paymentBrand error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use createTransaction(paymentBrand: String, protocolVersion: String) instead");
@end
...
SWIFT_PROTOCOL("_TtP19OPPWAMobile_ThreeDS25OPPThreeDSServiceCallback_")
@protocol OPPThreeDSServiceCallback
...
SWIFT_CLASS("_TtC19OPPWAMobile_ThreeDS21OPPThreeDSTransaction")
